...
function App() {
  ...
  let [shuffledOptions, setShuffledOptions] = useState([]); // State to store shuffled options

  useEffect(() => {
    axios("https://the-trivia-api.com/v2/questions")
      .then((res) => {
        setQuizData(res.data);
        shuffleOptions(res.data[0]); // Shuffle options for the first question
      })
      .catch((e) => {
        console.log(e);
      });
  ...
  return (
    <>
      <h1 className="text-center text-[4rem]">Quiz</h1>
